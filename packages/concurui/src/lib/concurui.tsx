...
export function Concurui() {
  return (
    <div className={'concurui'}>
      <h1>Welcome to Concurui!</h1>
      <div className="space-y-4">
        <div className="w-96 bg-white shadow rounded">w-96</div>
        <div className="w-80 bg-blue shadow rounded">w-80</div>
        <div className="w-72 bg-blue-500 shadow rounded">w-72</div>
        <div className="w-64 bg-red-500 shadow rounded">w-64</div>
